...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentManualTopUpPaymeURL:                             paymentCfg.ManualTopUpPaymeURL,
		PaymentManualTopUpAlipayURL:                            paymentCfg.ManualTopUpAlipayURL,
		PaymentManualTopUpWechatURL:                            paymentCfg.ManualTopUpWechatURL,
		PaymentManualTopUpContactURL:                           paymentCfg.ManualTopUpContactURL,
